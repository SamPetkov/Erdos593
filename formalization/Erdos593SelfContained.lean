...
This is the complete, kernel-checkable source closure of the formal proof of
the finite classification in Erdős Problem 593. It is self-contained with
respect to this repository:
