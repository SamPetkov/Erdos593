...
restriction. This is a local finite-trace bridge, not yet a global
...
`SequenceLiftBaseLetter` canonical trace-key modules on every pull request and
...
It contains 13,330 physical lines, 85 source modules, and 43 external Mathlib
