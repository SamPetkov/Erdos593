...
system is not obligatory. The project is still not a complete machine-checked
proof of Erdős Problem 593: the large-odd-girth avoidance construction and
the final global equivalence remain open.
...
It contains 23,402 physical lines, 162 source modules, and 52 external Mathlib
