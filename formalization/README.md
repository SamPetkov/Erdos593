...
fibre-cardinality sum or global trace decomposition. The project is not yet a
...
`SequenceLiftBaseFiberSupportIndex` canonical trace-key and fibre modules on
...
It contains 14,065 physical lines, 91 source modules, and 43 external Mathlib
