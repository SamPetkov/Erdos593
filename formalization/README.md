...
`SequenceLiftBaseFiberPartition` canonical trace-key and fibre modules on every pull request and
...
It contains 13,781 physical lines, 89 source modules, and 43 external Mathlib
