...
trace-decomposition claim. The project is not yet a complete machine-checked
...
`SequenceLiftBaseFiberPartition` / `SequenceLiftBaseApex` canonical trace-key
and fibre modules on every pull request and
...
It contains 13,940 physical lines, 90 source modules, and 43 external Mathlib
