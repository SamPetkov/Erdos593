...
The infinitary colouring and avoidance arguments form the remaining milestone.
...
reduction for obligatoriness, and the finite reduction from arbitrary
bipartite expansions to the `Kₙ,ₙ⁺` atoms. It is not yet a complete
machine-checked proof of Erdős Problem 593: the expansion atom,
rooted-abundance/obligatory one-point-amalgamation theorem, and the remaining
...
It contains 6,737 physical lines, 40 source modules, and 14 external Mathlib
